...
internal const val DEFAULT_CONNECTION_PORT = 8989
internal const val DEFAULT_PLOT_COLUMNS = 100
internal const val DEFAULT_PLOT_ROWS = 40
internal const val DEFAULT_PLOT_LAYOUT_COLUMNS = 15
internal const val DEFAULT_PLOT_LAYOUT_ROWS = 40

internal class MemDB(
    ...
    fun doPlot(
        ...
        if (trackedHeap.heapOperations.isEmpty()) {
            println(MESSAGE_NO_HEAP_OPERATIONS)
            return
        }
